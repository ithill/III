...
public class QueryDemo1 {
	public static void main(String[] args) {
		try {     
			...
			Connection conn = DriverManager.getConnection(connUrl, "sa", "P@ssw0rd");
		//	String connUrl = "jdbc:sqlserver://localhost:1433;databaseName=jdbc;user=sa;password=P@ssw0rd;";
